<?php get_header(); ?>
	...
	<div id="content" class="<?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		...
		<div class="single-navigation clearfix">
			<?php previous_post_link('%link', __('Anterior', 'Avada')); ?>
			<?php next_post_link('%link', __('Siguiente', 'Avada')); ?>
		</div>
		<?php endif; ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<?php if( ( $smof_data['social_sharing_box'] && get_post_meta($post->ID, 'pyre_share_box', true) != 'no' ) || 
				...
				<div class="fusion-sharing-box share-box">
					<h4><?php echo __('Comparte este articulo, Elija su plataforma!', 'Avada'); ?></h4>
			...
			<div class="about-author">
				<div class="fusion-title title"><h2 class="title-heading-left"><?php echo __('Sobre el Autor:', 'Avada'); ?> <?php the_author_posts_link(); ?></h2><div class="title-sep-container"><div class="title-sep sep-double"></div></div></div>
			...
			<div class="related-posts single-related-posts">
				<div class="fusion-title title"><h2 class="title-heading-left"><?php echo __('Artículos Relacionados', 'Avada'); ?></h2><div class="title-sep-container"><div class="title-sep sep-double"></div></div></div>
