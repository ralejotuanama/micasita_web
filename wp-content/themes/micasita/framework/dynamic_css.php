...
.gform_page_footer input[type=button]{
	...
	background-image: -webkit-gradient( linear, left bottom, left top, from( #00AB69 ), to( #00AB69 ) );
	background-image: -webkit-linear-gradient( bottom,#00AB69, #00AB69 );
	background-image:	-moz-linear-gradient( bottom, #00AB69, #00AB69 );
	background-image:	  -o-linear-gradient( bottom, #00AB69, #00AB69 );
	background-image: linear-gradient( to top,#00AB69, #00AB69 );	

	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#00AB69', endColorstr='#00AB69');
	<?php endif; ?>
...
.gform_page_footer input[type=button]:hover{
	...
	background-image: -webkit-gradient( linear, left bottom, left top, from( #ececec ), to( #ececec ) );
...
.page-title ul,.page-title ul li,.page-title ul li a{color:#fff;}
<?php endif; ?>
...
{color:#ffffff;border-color:<?php echo $smof_data['menu_hover_first_color']; ?>;}
