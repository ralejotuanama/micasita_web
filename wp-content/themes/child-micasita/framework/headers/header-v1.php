...
<div class="header-v1">
	<header id="header">
		<div class="avada-row" style="padding-top:<?php echo $smof_data['margin_header_top']; ?>;padding-bottom:<?php echo $smof_data['margin_header_bottom']; ?>;" data-padding-top="<?php echo $smof_data['margin_header_top']; ?>" data-padding-bottom="<?php echo $smof_data['margin_header_bottom']; ?>">
			...
			<div class="micasita">
				<div class="redes">
				<aside style="float: right; padding-top:7px; margin-bottom: 0px;padding-left: 10px;">

					<a target="_blank" href="https://www.facebook.com/pages/miCasita-hipotecaria-Los-especialistas-en-cr%C3%A9ditos-de-vivienda/190295837684294?fref=ts"><img style="width: 24px;" src="http://www.micasita.com.pe/wp-content/themes/micasita/images/facebook.png"></a>
					<a target="_blank" href="https://twitter.com/miCasita_H"><img style="width: 24px;" src="http://www.micasita.com.pe/wp-content/themes/micasita/images/twitter.png"></a>
				</aside>
				</div>

				<div class="buscar">
					<form class="search searchform" action="http://www.micasita.com.pe/" method="get">
					<fieldset>
						<span class="text"><input name="s" class="s" type="text" value="" placeholder="Buscador"></span>
					</fieldset>
					</form>
