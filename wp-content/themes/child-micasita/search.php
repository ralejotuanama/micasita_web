<?php get_header(); ?>
	...
	<div id="content" class="<?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
		...
		<div class="search-page-search-form">
			<h2><?php echo __('¿Necesita una nueva búsqueda?', 'Avada'); ?></h2>
			<p><?php echo __('Si no lo pudiste encontrar lo que estabas buscando, intente una nueva búsqueda!', 'Avada'); ?></p>
			<form class="searchform seach-form" role="search" method="get" action="<?php echo home_url( '/' ); ?>">
				<div class="search-table">
					<div class="search-field">
						<input type="text" value="" name="s" class="s" placeholder="<?php _e( 'Buscar ...', 'Avada' ); ?>"/>
					</div>
					...
					<div class="post-wrapper">
						...
						<div class="post-content-container">
							...
							<div class="meta-info">
								...
								<div class="alignleft">
									<?php if(!$smof_data['post_meta_read']): ?><a href="<?php the_permalink(); ?>" class="read-more"><?php echo __('Ver', 'Avada'); ?></a><?php endif; ?>
								</div>
								<?php endif; ?>
