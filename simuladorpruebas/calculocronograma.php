...
//inicializacion de variables
   ...
   if($int_Produc==1){
		if($r_valorInmueble>=58800 && $r_valorInmueble<=84100){
                ...
                else if($r_valorInmueble>8410 && $r_valorInmueble<=125900){
                   $dbl_MtoCon = 14600 ;
                }
                else if($r_valorInmueble>125900 && $r_valorInmueble<=209800){
                  $dbl_MtoCon = 13000 ;
                }
                else if($r_valorInmueble>209800 && $r_valorInmueble<=310800){
                  $dbl_MtoCon = 6400 ;
                }
                else{ $dbl_MtoCon = 0; }
	}else{
