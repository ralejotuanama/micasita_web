...
<div class="row-fluid" style="margin-top:0">
   ...
   <!-- inicio div span12-->
    <div class="span12" >
                ...
                <!--inicio form -->
                <form action="<?php echo base_url()?>index.php/panelcliente/editarlineabd" id="editarlineabd" method="post" enctype="multipart/form-data">
                    ...
                    <div class="widget-content tab-content">
                            ...
                            <div id="tab1" class="tab-pane active" style="min-height: 300px">
                                     <div class="span12" style="padding: 0%; margin-left: 0 ">  
                                       ...
                                       <div class="span3">
                                       <?php echo form_hidden('idlineaultimo', $result->idlinea) ?>   
