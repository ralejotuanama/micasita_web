    ...
    <!--<div class="quick-actions_homepage">-->
      <ul class="quick-actions">
        ...
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vProduto')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/productos"> <i class="icon-barcode"></i> Productos</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vServico')){ ?>
            <li class="bg_ly"> <a href="<?php echo base_url()?>index.php/servicios"> <i class="icon-wrench"></i> Servicios</a> </li>
        <?php } ?>
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Productos que ofrecemos</h5></div>
                    ...
                    <tbody>
                        ...
                        if($produtos != null){*/
                            foreach ($produtos as $p) {
                                echo '<tr>';
                               /* echo '<td style=text-align:center;>'.$p->idProductos.'</td>';*/
                                echo '<td style=text-align:center;>'.$p->descripcion.'</td>';
                               /* echo '<td>$ '.$p->precioVenta.'</td>';*/
                              /*  echo '<td>'.$p->stock.'</td>';*/
                               /* echo '<td>'.$p->stockMinimo.'</td>';
                                echo '<td>';
                                if($this->permission->checkPermission($this->session->userdata('permissao'),'eProduto')){
                                    echo '<a href="'.base_url().'index.php/produtos/editar/'.$p->idProductos.'" class="btn btn-info"> <i class="icon-pencil" ></i> </a>  '; 
                                }
                                echo '</td>';
                                echo '</tr>';*/
                            }
...
<div class="span12" style="margin-left: 0">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Clientes Registrados</h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
...
*/
    ...
    <div class="span12" style="margin-left: 0">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estados de solicitudes </h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                       <!-- <tr>
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estadísticas de Solicitudes</h5></div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
