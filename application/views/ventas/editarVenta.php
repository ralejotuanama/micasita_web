                        ...
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divEditarVenda">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span8 offset2" style="text-align: center">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/ventas/visualizar/<?php echo $result->idVendas; ?>" class="btn btn-inverse"><i class="icon-eye-open"></i> Visualizar Venta</a>
                                            <a href="<?php echo base_url() ?>index.php/ventas" class="btn"><i class="icon-arrow-left"></i> Volver</a>
                                        </div>
                                ...
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                        ...
                                        <form id="formProdutos" action="<?php echo base_url(); ?>index.php/ventas/adicionarProducto" method="post">
                                            <div class="span8">
                                        ...
                                        <table class="table table-bordered" id="tblProdutos">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($produtos as $p) {
                                                    ...
                                                    echo '<td><a href="" idAcao="'.$p->idItens.'" prodAcao="'.$p->idProductos.'" quantAcao="'.$p->quantidade.'" title="Eliminar Producto" class="btn btn-danger"><i class="icon-remove icon-white"></i></a></td>';
