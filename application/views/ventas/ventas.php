<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aVenda')){ ?>
    <a href="<?php echo base_url();?>index.php/ventas/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Agregar Venta</a>
<?php } ?>
...
<table class="table table-bordered ">
    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            echo '<td><a href="'.base_url().'index.php/clientes/visualizar/'.$r->idClientes.'">'.$r->nombreCliente.'</a></td>';
            echo '<td>'.$faturado.'</td>';
            
            echo '<td>';
            if($this->permission->checkPermission($this->session->userdata('permissao'),'vVenda')){
                echo '<a style="margin-right: 1%" href="'.base_url().'index.php/ventas/visualizar/'.$r->idVendas.'" class="btn tip-top" title="Ver mas detalles"><i class="icon-eye-open"></i></a>'; 
            }
            if($this->permission->checkPermission($this->session->userdata('permissao'),'eVenda')){
                echo '<a style="margin-right: 1%" href="'.base_url().'index.php/ventas/editar/'.$r->idVendas.'" class="btn btn-info tip-top" title="Editar venta"><i class="icon-pencil icon-white"></i></a>'; 
            }
