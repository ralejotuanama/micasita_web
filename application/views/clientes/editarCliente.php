            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="nombreCliente" type="text" name="nombreCliente" value="<?php echo $result->nombreCliente; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="ruc" type="text" name="ruc" value="<?php echo $result->ruc; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="barrio" type="text" name="barrio" value="<?php echo $result->barrio; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="ciudad" type="text" name="ciudad" value="<?php echo $result->ciudad; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="cep" type="text" name="cep" value="<?php echo $result->referencia; ?>"  />
                        </div>
                    </div>
