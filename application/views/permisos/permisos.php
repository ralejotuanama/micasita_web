...
<table class="table table-bordered ">
    ...
    <tbody>
        <?php foreach ($results as $r) {
            if($r->situacao == 1){$situacao = 'Activo';}else{$situacao = 'Inactivo';}
            echo '<tr>';
            ...
            echo '<td>'.$situacao.'</td>';
            echo '<td>
                      <a href="'.base_url().'index.php/permisos/editar/'.$r->idPermissao.'" class="btn btn-info tip-top" title="Editar Permisos"><i class="icon-pencil icon-white"></i></a>
