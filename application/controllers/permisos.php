    ...
    function adicionar() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = array(
                  ...
                  'aproveedores' => $this->input->post('aproveedores'),
                  'eproveedores' => $this->input->post('eproveedores'),
                  'dproveedores' => $this->input->post('dproveedores'),
                  'vproveedores' => $this->input->post('vproveedores'),
        ...
        $this->data['view'] = 'permisos/adicionarPermisos';
        $this->load->view('tema/topo', $this->data);
    ...
    function editar() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->permissoes_model->edit('permissoes', $data, 'idPermissao', $this->input->post('idPermissao')) == TRUE) {
                $this->session->set_flashdata('success', 'Permiso editado con exito');
                redirect(base_url() . 'index.php/permisos/editar/'.$this->input->post('idPermissao'));
            } else {
        ...
        $this->data['view'] = 'permisos/editarPermisos';
        $this->load->view('tema/topo', $this->data);
