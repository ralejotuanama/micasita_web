...
class Ventas extends CI_Controller {
	...
	function gerenciar(){
        ...
        $config['base_url'] = base_url().'index.php/ventas/gerenciar/';
    ...
    function adicionar(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'aVenda')){
          $this->session->set_flashdata('error','No tiene permiso para agregar venta.');
          redirect(base_url());
        }
        ...
        $this->data['view'] = 'ventas/adicionarVenta';
        $this->load->view('tema/topo', $this->data);
    }
    ...
    function editar() {
        ...
        if ($this->form_validation->run('vendas') == false) {
            ...
            if ($this->vendas_model->edit('vendas', $data, 'idVendas', $this->input->post('idVendas')) == TRUE) {
                $this->session->set_flashdata('success','Venta editada con exito');
                redirect(base_url() . 'index.php/ventas/editar/'.$this->input->post('idVendas'));
            } else {
                $this->data['custom_error'] = '<div class="form_error"><p>Ocurrió un error</p></div>';
            }
        }
        ...
        $this->data['view'] = 'ventas/editarVenta';
        $this->load->view('tema/topo', $this->data);
    ...
    public function visualizar(){
        ...
        $this->data['view'] = 'ventas/visualizarVenta';
        $this->load->view('tema/topo', $this->data);
    ...
    function excluir(){
        ...
        if ($id == null){
            ...
            redirect(base_url().'index.php/ventas/gerenciar/');
        }
